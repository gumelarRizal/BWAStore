                ...
                <div class="row">
                    ...
                    >
                        <a href="#" class="component-categories d-block">
                            ...
                            <p class="category-text">Gadgets</p>
                        </a>
                    </div>
                    <div
                        class="col-6 col-md-3 col-lg-2"
                    ...
                    >
                        <a href="#" class="component-categories d-block">
                            ...
                            <p class="category-text">Make up</p>
                        </a>
                    </div>
                    <div
                        class="col-6 col-md-3 col-lg-2"
                    ...
                    >
                        <a href="#" class="component-categories d-block">
                            ...
                            <p class="category-text">Sneakers</p>
                        </a>
                    </div>
                    <div
                        class="col-6 col-md-3 col-lg-2"
                        ...
                        >
                            <div class="products-thumbnail">
                                <div
                                    ...
                                    style="
                                        background-image: url(/images/AppleWatch.jpg);
                                    "
                                ></div>
                            </div>
                        ...
                        >
                            <div class="products-thumbnail">
                                <div
                                    class="products-image"
                                    style="
                                        background-image: url(images/orangeBogotta.jpg);
                                    "
                                ></div>
                            </div>
                        ...
                        >
                            <div class="products-thumbnail">
                                <div
                                    class="products-image"
                                    style="
                                        background-image: url(images/sofaTernyaman.jpg);
                                    "
                                ></div>
                            </div>
                        ...
                        >
                            <div class="products-thumbnail">
                                <div
                                    class="products-image"
                                    style="
                                        background-image: url(images/bubukMaketti.jpg);
                                    "
                                ></div>
                            </div>
                        ...
                        >
                            <div class="products-thumbnail">
                                <div
                                    class="products-image"
                                    style="
                                        background-image: url(images/tatakanGelas.jpg);
                                    "
                                ></div>
                            </div>
                        ...
                        >
                            <div class="products-thumbnail">
                                <div
                                    class="products-image"
                                    style="
                                        background-image: url(images/mavicKawe.jpg);
                                    "
                                ></div>
                            </div>
                        ...
                        >
                            <div class="products-thumbnail">
                                <div
                                    class="products-image"
                                    style="
                                        background-image: url(images/monkeyToys.jpg);
                                    "
                                ></div>
                            </div>
